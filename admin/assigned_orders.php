...
if (isset($_GET['cancel'])) {
    ...
    $status = "Canceled";
    $stmt = prepare_query("UPDATE orders SET status=? WHERE order_id=?");
    ...
    redirect("assigned_orders.php?success=order_cancel");
}
?>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $stmt = query("SELECT * FROM orders WHERE delivery_status='On The Way' && driver_id={$driver_id} && status='Success'");
                            ...
                            <tr>
                                ...
                                <td><a href="assigned_orders.php?success=<?php echo $order_id; ?>"
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $stmt = query("SELECT * FROM orders WHERE delivery_status='On The Way' && cus_id={$customer_id} && status='Success'");
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    $order_id = $row['order_id'];
                                    $order_date = $row['order_date'];
                            ...
                            <tr>
                                ...
                                <td><a onClick="javascript: return confirm('Do want to cancel this order?');"
                                        href="assigned_orders.php?cancel=<?php echo $order_id; ?>"
