...
require_once(__DIR__."/SslCommerzInterface.php");

abstract class AbstractSslCommerz implements SslCommerzInterface
{
    protected $apiUrl; //api url //changes for local or live servers
    protected $storeId; //from mail 
    protected $storePassword;//from mail
    ...
    //--------------------THE rest are functions that manage the REST API's urls-----------------
